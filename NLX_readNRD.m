function NRD = NLX_readNRD(fPath,ADChan,ExtractMode,ExtractArray)
...
%% Search for START position; SFX = 2048
ok = false;
while ~ok
...
StartTime = readDataPackage(fid,numExtras,numChan);
...
function [cTimeStamp,cData] = readDataToBuffer(fid,numExtras,numChan,iCh)
numPacket = 7 + numExtras + numChan + 1; 
